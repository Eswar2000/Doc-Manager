...
export const templateApi = {
    ...
    createTemplate: async (templateData: Omit<TemplateProps, 'id' | 'createdAt' | 'createdBy' | 'modifiedAt' | 'modifiedBy' | 'state' | 'version' | 'parentTemplateId' | 'tenantId'>): Promise<TemplateProps> => {
        const new_template = await api.post<TemplateProps>('/templates', templateData);
        return new_template.data;
    },
    updateTemplate: async (templateId: string, templateData: Omit<TemplateProps, 'id' | 'createdAt' | 'createdBy' | 'modifiedAt' | 'modifiedBy' | 'state' | 'version' | 'parentTemplateId' | 'tenantId'>): Promise<TemplateProps> => {
