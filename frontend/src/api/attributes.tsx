...
export const attributeApi = {
    ...
    createAttribute: async (attributeData: Omit<AttributeProps, 'id' | 'createdAt' | 'updatedAt'>): Promise<AttributeProps> => {
    ...
    updateAttribute: async (attributeId: string, attributeData: Partial<Omit<AttributeProps, 'id' | 'createdAt' | 'updatedAt' | 'type'>>): Promise<AttributeProps> => {
